...
![Mail Sender - Atividade Envio de Email]()

# **DIAGRAMA DE SEQUÊNCIAS**

![Mail Sender - Sequência Cadastro]()
![Mail Sender - Sequência Envio de email]()
![Mail Sender - Sequência Aprovação API Key]()
![Mail Sender - Sequência Revogação API Key]()
![Mail Sender - Sequência Inativar-Reativar API Key]()
